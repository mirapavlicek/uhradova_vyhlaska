...
export type RouteGroup = 'start' | 'acute' | 'hospital' | 'primary' | 'ambulatory' | 'tools'
...
export const ROUTES: RouteDef[] = [
  ...
  { id: 'physio', label: 'Fyzioterapie (902)', group: 'ambulatory' },
  { id: 'homecare', label: 'Domácí a paliativní péče (925, 916, 926, 913)', group: 'ambulatory' },
...
export const GROUP_ORDER: RouteGroup[] = ['start', 'acute', 'hospital', 'primary', 'ambulatory', 'tools']
